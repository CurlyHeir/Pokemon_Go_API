...
_REQUESTENVELOP = _descriptor.Descriptor(
    ...
    nested_types=[_REQUESTENVELOP_REQUESTS, _REQUESTENVELOP_UNKNOWN3, _REQUESTENVELOP_UNKNOWN6,
                  _REQUESTENVELOP_AUTHINFO, ],
    enum_types=[
    ],
    options=None,
    is_extendable=False,
...
_RESPONSEENVELOP_PROFILE_DAILYBONUS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='NextCollectTimestampMs', full_name='ResponseEnvelop.Profile.DailyBonus.NextCollectTimestampMs',
            index=0,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='ResponseEnvelop.Profile.DailyBonus.NextDefenderBonusCollectTimestampMs', index=1,
            number=2, type=3, cpp_type=2, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
_RESPONSEENVELOP_PROFILE = _descriptor.Descriptor(
    ...
    nested_types=[_RESPONSEENVELOP_PROFILE_AVATARDETAILS, _RESPONSEENVELOP_PROFILE_DAILYBONUS,
                  _RESPONSEENVELOP_PROFILE_CURRENCY, ],
    enum_types=[
    ],
    options=None,
    is_extendable=False,
...
_RESPONSEENVELOP = _descriptor.Descriptor(
    ...
    nested_types=[_RESPONSEENVELOP_UNKNOWN6, _RESPONSEENVELOP_UNKNOWN7, _RESPONSEENVELOP_PAYLOAD,
